...
Tabulous.setup do |config|
  ...
  config.tabs do
    [
      ...
      #---------------------------------------------------------------------------------------------------------------------#
      [    :users_tab   ,    'Users'             , users_path             ,false           ,false            ],
      [    :homes_tab              ,    'Dashboard'              ,    homes_path              ,    true        ,    true        ],
      [    :users_tab   ,    'Account Details'             , account_details_url             ,true           ,true            ],
      [    :projects_tab   ,    'Projects'             , projects_path             ,true           ,true            ],
      [    :requirements_tab       ,    'Requirements'    ,  requirements_path              ,    true        ,    true        ],
      [    :use_cases_tab   ,    'UseCases'             , use_cases_path             ,true           ,true            ],
      [    :members_tab   ,    'People'             , members_path             ,true           ,true            ],
      [    :member_member_sessions_tab,'Member' ,    homes_path,               false,      false]
      #---------------------------------------------------------------------------------------------------------------------#
      #    TAB NAME                |    DISPLAY TEXT         |    PATH                    |    VISIBLE?    |    ENABLED?    #
      #---------------------------------------------------------------------------------------------------------------------#
    ]
  ...
  config.actions do
    [
      ...
      #--------------------------------------------------------------------------#
      [    :homes              ,    :all_actions    ,    :homes_tab              ],
      [    :requirements       ,    :all_actions    ,    :requirements_tab              ],
      [    :projects           ,    :all_actions    ,    :projects_tab  ],
      [    :use_cases           ,    :all_actions    ,    :use_cases_tab  ],
